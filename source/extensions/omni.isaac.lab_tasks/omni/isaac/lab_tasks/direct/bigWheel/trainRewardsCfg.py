...
class TrainRewards:
    def __init__(self):
        # reward scales
        self.lin_vel_reward_scale = 5.0  # 线速度奖励 0.3
        self.yaw_rate_reward_scale = 1.0  # yaw 转向速度奖励 0.1
        self.velocity_coupling_reward_scale = 0.0  # 速度耦合奖励 0.7
        self.height_reward_scale = 5.0  # 高度奖励
        self.z_vel_reward_scale = -0.3  # 垂直速度奖励
        self.ang_vel_reward_scale = -0.03  # pitch roll角速度奖励
        self.joint_torque_reward_scale_inner = -2.5e-5  # 内轮关节扭矩奖励
        self.joint_accel_reward_scale_inner = -2.5e-6  # 内轮关节加速度奖励
        self.joint_torque_reward_scale_outer = -2.5e-5  # 外轮关节扭矩奖励
    ...
    def getReward(
        ...
        #     _commands[:, 2] - bigWheel.data.root_pos_w[:, 2]
        # )
        # #! 将误差线性映射到奖励范围
