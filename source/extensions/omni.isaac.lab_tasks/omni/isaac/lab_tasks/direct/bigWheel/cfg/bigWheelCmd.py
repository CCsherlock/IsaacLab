...
if TYPE_CHECKING:
    ...
    from .bigWheelCmd_cfg import BigWheelVelocityCommandCfg


class BigWheelVelocityCommand(CommandTerm):
    ...
    cfg: BigWheelVelocityCommandCfg
    """The configuration of the command generator."""

    def __init__(self, cfg: BigWheelVelocityCommandCfg, env: ManagerBasedEnv):
